...
class BlackboardManager:
    ...
    def __init__(self) -> None:
        self._boards: dict[str, RoundBlackboard] = {}
        self._lock: asyncio.Lock = asyncio.Lock()
    ...
    def get_or_create(
        ...
        elif board.campaign_id != campaign_id:
            logger.warning(
                "blackboard.manager.campaign_mismatch",
                extra={
                    "round_id": round_id,
                    "existing_campaign_id": board.campaign_id,
    ...
    def discard(self, round_id: str) -> RoundBlackboard | None:
        ...
        """
        board = self._boards.pop(round_id, None)
    ...
    def active_boards(self) -> dict[str, RoundBlackboard]:
        """Return a snapshot mapping ``round_id`` to its active blackboard."""
